    ...
    if (props.english) {
        return (
            <div style={{paddingTop: '150px', paddingLeft: '50px', paddingRight: '50px', paddingBottom: '50px'}}>
                <p className='headerText' style={{textAlign: 'center', fontSize:'50px', fontWeight:'bold'}}>Featured Recipes</p>
                <div><br></br></div>
                <div className="card-deck">
                    <div className="card">
                        <img className="card-img-top" src={RecipeOne} alt="Enchiladas"/>
                        <div className="card-block">
                        <h4 className="card-title">Green Enchiladas</h4>
                        <p className="card-text">Classic Swiss Enchiladas with melted mozzarella cheese, sour cream, red onion, and homestyle salsa verde</p>
                        <p className="card-text"><small className="text-muted">Ready in less than one hour</small></p>
                        <Button onClick={onSubmit} variant="primary">See Recipe</Button>
                        </div>
                    </div>
                    <div className="card">
                        <img className="card-img-top" src={RecipeTwo} alt="Tamales"/>
                        <div className="card-block">
                        <h4 className="card-title">Green Tamales</h4>
                        <p className="card-text">Homestyle green Mole tamales. Cobine with refried beans and a homestyle salsa verde.</p>
                        <p className="card-text"><small className="text-muted">4 hours of work but very much worth the effort</small></p>
                        <Button onClick={onSubmitTwo} variant="primary">See Recipe</Button>
                        </div>
                    </div>
                    <div className="card">
                        <img className="card-img-top" src={RecipeThree} alt="ChocoFlan"/>
                        <div className="card-block">
                        <h4 className="card-title">ChocoFlan</h4>
                        <p className="card-text">Two story ChocoFlan. A moist chocolate cake with flan on top. Glazed with caramel and optional nuts</p>
                        <p className="card-text"><small className="text-muted">Legends says some people actually like this...</small></p>
        ...
        return (
            <div style={{paddingTop: '150px', paddingLeft: '50px', paddingRight: '50px', paddingBottom: '50px'}}>
                <p className='headerText' style={{textAlign: 'center', fontSize:'50px', fontWeight:'bold'}}>Recetas Destacadas</p>
                <div><br></br></div>
                <div className="card-deck">
                    <div className="card">
                        <img className='card-img-top' src={RecipeOne} alt="Featured Recipe 1"/>
                        <div className="card-block">
                        <h4 className="card-title">Enchiladas Verdes</h4>
                        <p className="card-text">Enchiladas Suizas con queso gratinado, crema, cebolla morada, y salsa verde casera</p>
                        <p className="card-text"><small className="text-muted">Listas en menos de una hora</small></p>
                        <Button onClick={onSubmit} variant="primary">Adelante</Button>
                        </div>
                    </div>
                    <div className="card">
                        <img className="card-img-top" src={RecipeTwo} alt="Featrured Recipe 2"/>
                        <div className="card-block">
                        <h4 className="card-title">Tamales Verdes</h4>
                        <p className="card-text">Tamales de Mole verde combina perfecto con frijoles refritos y una salsa verde casera.</p>
                        <p className="card-text"><small className="text-muted">4 Horas de trabajo pero valen mucho la pena</small></p>
                        <Button onClick={onSubmitTwo} variant="primary">Adelante</Button>
                        </div>
                    </div>
                    <div className="card">
                        <img className="card-img-top" src={RecipeThree} alt="Featured Recipe 3"/>
                        <div className="card-block">
                        <h4 className="card-title">Flan</h4>
                        <p className="card-text">Un Chocoflan de dos pisos. Un pastel de chocolate con flan en sima glazeado con leche quemada.</p>
                        <p className="card-text"><small className="text-muted">Para regalarselo a otra gente</small></p>
